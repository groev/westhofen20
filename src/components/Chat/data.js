const data = [
	...
	},
	{
		...
		messages: [
			...
			"I've been designing and developing stuff for the web since I'm 14. The first website I've done was for my CS clan ;-)",
			'I am working for a small agency shop in Solingen and my main focus is building cool frontends with React.',
		],
		answers: [
